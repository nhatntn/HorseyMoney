        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8 animate-bounce-in">
            ...
            <div className="flex items-center justify-center gap-2 mb-3">
              <Sparkle size={10} className="text-amber-400/90" />
              <span className="px-3 py-1 rounded-full bg-gradient-to-r from-amber-500/20 to-red-500/20 border border-amber-400/40 text-amber-200 font-semibold text-sm tracking-wide shadow-[0_0_12px_rgba(251,191,36,0.2)]">
                🐴 Năm Bính Ngọ 2026
              </span>
              <Sparkle size={10} className="text-amber-400/90" />
            </div>
            ...
            {/* Title */}
            <h1 className="text-5xl font-extrabold mb-3 pb-0.5 text-shimmer drop-shadow-[0_2px_8px_rgba(0,0,0,0.3)]" style={{ fontFamily: "'Dancing Script', cursive" }}>
              Horsey Money
            </h1>
